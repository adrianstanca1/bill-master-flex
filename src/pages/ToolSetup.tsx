      ...
      <Card>
        ...
        <CardContent>
          ...
          <ul className="text-sm text-muted-foreground list-disc pl-5 space-y-1">
            ...
            <li>
              Check logs: <a className="text-primary hover:underline" href={`${supabaseDashboardUrl}/functions/agent/logs`} target="_blank" rel="noreferrer">Agent Logs</a>
              {" • "}
              <a className="text-primary hover:underline" href={`${supabaseDashboardUrl}/functions/advisor/logs`} target="_blank" rel="noreferrer">Advisor Logs</a>
              {" • "}
              <a className="text-primary hover:underline" href={`${supabaseDashboardUrl}/functions/rams/logs`} target="_blank" rel="noreferrer">RAMS Logs</a>
            </li>
          </ul>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <ul className="text-sm text-muted-foreground list-disc pl-5 space-y-1">
            ...
            <li>
              Check logs: <a className="text-primary hover:underline" href={`${supabaseDashboardUrl}/functions/tenderbot/logs`} target="_blank" rel="noreferrer">TenderBot Logs</a>
            </li>
          </ul>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <ul className="text-sm text-muted-foreground list-disc pl-5 space-y-1">
            ...
            <li>
              Check logs: <a className="text-primary hover:underline" href={`${supabaseDashboardUrl}/functions/smartops/logs`} target="_blank" rel="noreferrer">SmartOps Logs</a>
            </li>
          </ul>
        </CardContent>
      </Card>

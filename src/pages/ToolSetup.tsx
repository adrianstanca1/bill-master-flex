      ...
      <Card>
        ...
        <CardContent>
          ...
          <ul className="text-sm text-muted-foreground list-disc pl-5 space-y-1">
            ...
            <li>
              Check logs: <a className="text-primary hover:underline" href={`https://supabase.com/dashboard/project/zpbuvuxpfemldsknerew/functions/agent/logs`} target="_blank" rel="noreferrer">Agent Logs</a>
              {" • "}
              <a className="text-primary hover:underline" href={`https://supabase.com/dashboard/project/zpbuvuxpfemldsknerew/functions/advisor/logs`} target="_blank" rel="noreferrer">Advisor Logs</a>
              {" • "}
              <a className="text-primary hover:underline" href={`https://supabase.com/dashboard/project/zpbuvuxpfemldsknerew/functions/rams/logs`} target="_blank" rel="noreferrer">RAMS Logs</a>
            </li>
          </ul>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <ul className="text-sm text-muted-foreground list-disc pl-5 space-y-1">
            ...
            <li>
              Check logs: <a className="text-primary hover:underline" href={`https://supabase.com/dashboard/project/zpbuvuxpfemldsknerew/functions/tenderbot/logs`} target="_blank" rel="noreferrer">TenderBot Logs</a>
            </li>
          </ul>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <ul className="text-sm text-muted-foreground list-disc pl-5 space-y-1">
            ...
            <li>
              Check logs: <a className="text-primary hover:underline" href={`https://supabase.com/dashboard/project/zpbuvuxpfemldsknerew/functions/smartops/logs`} target="_blank" rel="noreferrer">SmartOps Logs</a>
            </li>
          </ul>
        </CardContent>
      </Card>

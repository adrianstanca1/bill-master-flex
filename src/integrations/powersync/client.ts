// Import from the UMD build of PowerSync to avoid bundling issues with
// the default CommonJS entry. The UMD bundle exposes the same API but is
// friendlier with Vite's build pipeline.
import {
  Schema,
  Table,
  column,
  PowerSyncDatabase
} from '@powersync/web/umd';

...
export function SecurityConfigurationManager() {
  ...
  const handleOpenSupabaseUsers = () => {
    window.open('https://supabase.com/dashboard/project/zpbuvuxpfemldsknerew/auth/users', '_blank');
  };

  const handleOpenSupabaseFunctions = () => {
    window.open('https://supabase.com/dashboard/project/zpbuvuxpfemldsknerew/functions', '_blank');
  };
            ...
            <CardContent>
              <Button 
                ...
                onClick={() => {
                  ...
                  else if (check.link === 'sql') window.open('https://supabase.com/dashboard/project/zpbuvuxpfemldsknerew/sql/new', '_blank');
                }}
                className="w-full"
              >
                {check.action}
